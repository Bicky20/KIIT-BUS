...
// This file was automatically generated by @kiit-bus/bindgen@0.1.0.
...
export class Backend implements backendInterface {
    ...
    async confirmBus(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.confirmBus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getBusLocation(arg0: bigint): Promise<Location | null> {
        if (this.processError) {
            try {
    ...
    async getBusesOnRoute(arg0: bigint): Promise<Array<Bus>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBusesOnRoute(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserConfirmedBus(arg0: string): Promise<bigint | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserConfirmedBus(arg0);
    ...
    async updateBusLocation(arg0: bigint, arg1: number, arg2: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBusLocation(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
